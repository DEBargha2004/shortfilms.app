          ...
          <div className="grid flex-1 auto-rows-max gap-4 @container">
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)}>
                <div className="grid gap-4 @4xl:grid-cols-3 lg:gap-8">
                  <section className="grid auto-rows-max items-start gap-4 @4xl:col-span-2 @7xl:col-span-2 lg:gap-8">
                    <Card className="@container bg-dark-accent">
                              ...
                              <FormControl>
                                <div
                                  className={cn(
                                    ...
                                    "divide-y @lg:divide-y-0 @lg:divide-x bg-background",
                                  )}
                                >
                                  <Dialog
                  ...
                  <section className="grid @7xl:w-4/5 auto-rows-max items-start gap-4 lg:gap-8">
                    <Card className="bg-dark-accent">
